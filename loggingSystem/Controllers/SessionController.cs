...
namespace loggingSystem.Controllers
{
    ...
    public class SessionController : ControllerBase
    {
        ...
        public SessionController(ISaveFile saveFile)
        {
                                      ...
                                      [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<Session>> logEntries = new List<LogDataFormat<Session>>();
                ...
                List<LogDataFormat<Session>> result = JsonSerializer.Deserialize<List<LogDataFormat<Session>>>(data);
