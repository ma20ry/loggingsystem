...
using Commons.HealthExpenseManagement.Data.Entities.Benefits;
...
{  [ApiController]
    ...
    public class SessionSubBenefitController : ControllerBase
    {
        private readonly ISaveFile saveFile;

        public SessionSubBenefitController(ISaveFile saveFile)
        {
                                     ...
                                     [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<SessionSubBenefit>> logEntries = new List<LogDataFormat<SessionSubBenefit>>();
                ...
                List<LogDataFormat<SessionSubBenefit>> result = JsonSerializer.Deserialize<List<LogDataFormat<SessionSubBenefit>>>(data);
