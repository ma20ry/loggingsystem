...
using Commons.HealthExpenseManagment.Data.Entities.Benefits;
...
namespace loggingSystem.Controllers
{
    ...
    public class MainBenefitController : ControllerBase
    {
        private readonly ISaveFile saveFile;

        public MainBenefitController(ISaveFile saveFile)
        {
                                       ...
                                       [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<MainBenefit>> logEntries = new List<LogDataFormat<MainBenefit>>();
                ...
                List<LogDataFormat<MainBenefit>> result = JsonSerializer.Deserialize<List<LogDataFormat<MainBenefit>>>(data);
