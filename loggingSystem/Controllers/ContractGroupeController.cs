...
namespace loggingSystem.Controllers
{
    ...
    [ApiController]
    public class ContractGroupeController : ControllerBase
    {
                                   ...
                                   [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<ContractGroupe>> logEntries = new List<LogDataFormat<ContractGroupe>>();
                ...
                List<LogDataFormat<ContractGroupe>> result = JsonSerializer.Deserialize<List<LogDataFormat<ContractGroupe>>>(data);
