    ...
    public class BenefitType : ControllerBase
    {
                                         ...
                                         [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<BenefitType>> logEntries = new List<LogDataFormat<BenefitType>>();
                ...
                List<LogDataFormat<BenefitType>> result = JsonSerializer.Deserialize<List<LogDataFormat<BenefitType>>>(data);
