...
{  
    ...
    public class SubBenefitsController : Controller
    {
        private readonly ISaveFile saveFile;

        public SubBenefitsController(ISaveFile saveFile)
        {
                                    ...
                                    [FromQuery] string filterData = null)
        {
            ...
            try
            {
                ...
                string data = " ";
                List<LogDataFormat<SubBenefit>> logEntries = new List<LogDataFormat<SubBenefit>>();
                ...
                List<LogDataFormat<SubBenefit>> result = JsonSerializer.Deserialize<List<LogDataFormat<SubBenefit>>>(data);
